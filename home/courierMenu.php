    ...
    <form action="courierMenu.php" method="POST" enctype="multipart/form-data">
        <div style="overflow-x:auto;">
            <table border="0px solid" style="margin: auto; font-weight:bold;border-spacing: 5px 15px;">
                <th colspan="4" style="text-align: center;background-color:#ed8eba; width: 140px; height: 50px;">Fill The Details Of Sender & Receiver</th>
                <tr>
                ...
                <tr>
                    <td colspan="4" align="center"><input type="submit" name="submit" value="Place Order" style="background-color:#bad1e7;border-radius: 5px;width: 135px;height: 44px;cursor:pointer;margin-top: 21px;"></td>
                </tr>
            </table>
        </div>
    </form>
